...
from ..utils.material_bake_v3 import Bake
...
class QBAKER_OT_material_bake(Operator, Bake, ExportUVLayout):
    ...
    MAP_TO_PRINCIPLED_BSDF = {
        ...
        "SUBSURFACE": ("Subsurface", None),
        "": ("Subsurface Radius", None),
        "SUBSURFACE_COLOR": ("Subsurface Color", None),
        ...
        "CLEARCOAT_ROUGHNESS": ("Clearcoat Roughness", None),
        "IOR": ("IOR", None),
        "TRANSMISSION": ("Transmission", None),
        "TRANSMISSION_ROUGHNESS": ("Transmission Roughness", None),
        "EMISSION": ("Emission", None),
        "EMISSION_STRENGTH": ("Emission Strength", None),
        "ALPHA": ("Alpha", None),
        "NORMAL": ("Normal", None),
        "CLEARCOAT_NORMAL": ("Clearcoat Normal", None),
