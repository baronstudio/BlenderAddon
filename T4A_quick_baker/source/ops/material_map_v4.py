            ...
            if node.type == "BSDF_PRINCIPLED":
                for input in node.inputs:
                    if input.name == "Base Color":
                        ...
                        if input.is_linked or input.default_value != 1.5:
                            map_type = "IOR"
                        ...
                        map_type = "NORMAL"
                    elif input.name == "Subsurface Weight":
                        if input.is_linked or input.default_value != 0.0:
                            map_type = "SUBSURFACE_WEIGHT"
                    elif input.name == "Subsurface Scale":
                        if input.is_linked or input.default_value != 0.05000000074505806:
                            map_type = "SUBSURFACE_SCALE"
                    elif node.subsurface_method == "RANDOM_WALK_SKIN" and input.name == "Subsurface IOR":
                        if input.is_linked or input.default_value != 1.399999976158142:
                            map_type = "SUBSURFACE_IOR"
                    elif node.subsurface_method != "BURLEY" and input.name == "Subsurface Anisotropy":
                        if input.is_linked or input.default_value != 0.0:
                            map_type = "SUBSURFACE_ANISOTROPY"
                    elif input.name == "Specular IOR Level":
                        if input.is_linked or input.default_value != 0.5:
                            map_type = "SPECULAR"
                        ...
                        map_type = "TANGENT"
                    elif input.name == "Transmission Weight":
                        if input.is_linked or input.default_value != 0.0:
                            map_type = "TRANSMISSION_WEIGHT"
                    elif input.name == "Coat Weight":
                        if input.is_linked or input.default_value != 0.0:
                            map_type = "COAT_WEIGHT"
                    elif input.name == "Coat Roughness":
                        if input.is_linked or input.default_value != 0.029999999329447746:
                            map_type = "COAT_ROUGHNESS"
                    elif input.name == "Coat IOR":
                        if input.is_linked or input.default_value != 1.5:
                            map_type = "COAT_IOR"
                    elif input.name == "Coat Tint":
                        if input.is_linked or input.default_value[:] != (
                            1.0,
                            1.0,
                            1.0,
                            ...
                            map_type = "COAT_TINT"
                    elif input.name == "Coat Normal" and input.is_linked:
                        map_type = "COAT_NORMAL"
                    elif input.name == "Sheen Weight":
                        if input.is_linked or input.default_value != 0.0:
                            map_type = "SHEEN_WEIGHT"
                    elif input.name == "Sheen Roughness":
                        if input.is_linked or input.default_value != 0.5:
                            map_type = "SHEEN_ROUGHNESS"
                        ...
                        if input.is_linked or input.default_value[:] != (
                            ...
                            map_type = "SHEEN_TINT"
                    elif input.name == "Emission Color":
                        if input.is_linked or input.default_value[:] != (
                            1.0,
                            1.0,
                            1.0,
            ...
            if node.type == "BSDF_PRINCIPLED":
                for input in node.inputs:
                    if input.name == "Base Color" and input.is_linked:
                        ...
                        map_type = "NORMAL"
                    elif input.name == "Subsurface Weight" and input.is_linked:
                        map_type = "SUBSURFACE_WEIGHT"
                    elif input.name == "Subsurface Scale" and input.is_linked:
                        map_type = "SUBSURFACE_SCALE"
                    elif (
                        node.subsurface_method == "RANDOM_WALK_SKIN"
                        and input.name == "Subsurface IOR"
                        and input.is_linked
                    ):
                        map_type = "SUBSURFACE_IOR"
                    elif (
                        node.subsurface_method != "BURLEY" and input.name == "Subsurface Anisotropy" and input.is_linked
                    ):
                        map_type = "SUBSURFACE_ANISOTROPY"
                    elif input.name == "Specular IOR Level" and input.is_linked:
                        map_type = "SPECULAR"
                        ...
                        map_type = "TANGENT"
                    elif input.name == "Transmission Weight" and input.is_linked:
                        map_type = "TRANSMISSION_WEIGHT"
                    elif input.name == "Coat Weight" and input.is_linked:
                        map_type = "COAT_WEIGHT"
                    elif input.name == "Coat Roughness" and input.is_linked:
                        map_type = "COAT_ROUGHNESS"
                    elif input.name == "Coat IOR" and input.is_linked:
                        map_type = "COAT_IOR"
                    elif input.name == "Coat Tint" and input.is_linked:
                        map_type = "COAT_TINT"
                    elif input.name == "Coat Normal" and input.is_linked:
                        map_type = "COAT_NORMAL"
                    elif input.name == "Sheen Weight" and input.is_linked:
                        map_type = "SHEEN_WEIGHT"
                    elif input.name == "Sheen Roughness" and input.is_linked:
                        map_type = "SHEEN_ROUGHNESS"
                    elif input.name == "Sheen Tint" and input.is_linked:
                        map_type = "SHEEN_TINT"
                    elif input.name == "Emission Color" and input.is_linked:
                        map_type = "EMISSION"
